...
<body class="bg-body-secondary">
  ...
  <path d="M4.81 1.37A6.5 6.5 0 0 1 14.56 7a.5.5 0 1 1-1 0 5.5 5.5 0 0 0-8.25-4.765.5.5 0 0 1-.5-.865Zm-.89 1.257a.5.5 0 0 1 .04.706A5.478 5.478 0 0 0 2.56 7a.5.5 0 0 1-1 0c0-1.664.626-3.184 1.655-4.333a.5.5 0 0 1 .706-.04ZM1.915 8.02a.5.5 0 0 1 .346.616l-.779 2.767a.5.5 0 1 1-.962-.27l.778-2.767a.5.5 0 0 1 .617-.346Zm12.15.481a.5.5 0 0 1 .49.51c-.03 1.499-.161 3.025-.727 4.533l-.07.187a.5.5 0 0 1-.936-.351l.07-.187c.506-1.35.634-2.74.663-4.202a.5.5 0 0 1 .51-.49Z"/>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 navbar-opcoes">
              <li class="nav-item"> 
              <li class="navbar-entrar"><a class="dropdown-item" href="login.php">Entrar no sistema</a></li>
              </li>
              <li class="nav-item"> 
              ...
              <!-- <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="login.php">Entrar no sistema</a></li>
  ...
  <form method="POST" action="">
        ...
        <hr>
        <button type="button" id="fecharJanelas" name="fecharJanelas" class="btn btn-danger fecharJanelas" onclick="removeTodasJanelasFlutuantes()">
        ...
        </svg> Fechar todas as janelas</button>
        <a href="index.php#topo" class="arrow-up">
  ...
  <select id="selecionaTabl" name="selecionaTabl" class="form-select" aria-label="Default select example">
...
<dialog id="msgAviso" name="msgAviso">
  <div>
    <p class="h5">Alterar informações?</p>
  </div>
  <button id="cancel" name="cancel" onclick="janelaDeEdição();" class="btn btn-warning">Sim</button>
  <button onclick="msgAviso.close()" class="btn btn-success">Voltar</button>
</dialog>
        <div class="table-responsive bg-secondary-subtle tbl">
    <table class="table table-striped table-hover border border-secondary">
  <thead>
    <tr>
      <th scope="col"><button type="button" id="adicionaCad-btn" name="adicionaCad-btn" class="btn btn-primary" onclick="novoCad();"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
  <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
</svg></button></th>
  ...
  <tbody id="newPerfil" name="newPerfil">
    <tr class="perfil-tbl">
      ...
      <td colspan="1"><button type="button" id="abrirPerfil" name="abrirPerfil" class="btn btn-info"  onclick="janelaFlutuante();"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-window-stack" viewBox="0 0 16 16">
  <path d="M4.5 6a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1ZM6 6a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Zm2-.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z"/>
  <path d="M12 1a2 2 0 0 1 2 2 2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2 2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h10ZM2 12V5a2 2 0 0 1 2-2h9a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1Zm1-4v5a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V8H3Zm12-1V5a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v2h12Z"/>
</svg></button></td>
<td colspan="1"><button type="button" id="edit-btn" name="edit-btn" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
